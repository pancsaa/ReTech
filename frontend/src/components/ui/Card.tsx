...
const Cards: React.FC<CardProps> = ({
  ...
  return (
    <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs overflow-hidden">
      <a href="#">
        <img
          className="rounded-t-base w-full object-cover"
          src={image}
          alt={title}
        />
      </a>
      ...
      <div className="p-6 text-center">
        ...
        <button
          type="button"
          onClick={onClick}
          className="inline-flex items-center text-white bg-brand border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
        >
          {buttonText}
          <svg
